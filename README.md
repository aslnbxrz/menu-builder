...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/menu-builder.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/menu-builder)
...
```php
$menuBuilder = new Aslnbxrz\MenuBuilder();
echo $menuBuilder->echoPhrase('Hello, Aslnbxrz!');
```
